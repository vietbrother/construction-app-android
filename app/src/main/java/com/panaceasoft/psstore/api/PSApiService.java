package com.panaceasoft.psstore.api;
...
import com.panaceasoft.psstore.viewobject.TransactionHeaderUpload;
...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<com.panaceasoft.psstore.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("product_id") String productId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<com.panaceasoft.psstore.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
