...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.panaceasoft.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.psstore.viewmodel.comment.CommentListViewModel.TmpDataHolder();
