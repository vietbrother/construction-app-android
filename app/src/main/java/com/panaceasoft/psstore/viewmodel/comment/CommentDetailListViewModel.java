package com.panaceasoft.psstore.viewmodel.comment;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.panaceasoft.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.psstore.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
